...
class BarangController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $validated = $request->validate([
            ...
            'harga_gold' => 'nullable|numeric|min:0|max:9999999999999.99',
            'harga_grosir' => 'nullable|numeric|min:0|max:9999999999999.99',
            'harga_khusus' => 'nullable|numeric|min:0|max:9999999999999.99',
        ]);
    ...
    protected function getPriceColumnsForRole(): array
    {
        ...
        if (in_array($role, ['super_admin', 'admin', 'manager', 'audit'])) {
        ...
        try {
            ...
            foreach ($rows as $row) {
                ...
                if ($existing) {
                    ...
                    $barang = Barang::create(array_merge($data, ['kode_barang' => $kodeBarang]));
