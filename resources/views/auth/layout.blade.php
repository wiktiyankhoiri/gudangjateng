...
<head>
    ...
    <title>{{ $title ?? 'Login - GudangJateng' }}</title>
            ...
            <div class="relative items-center hidden w-full h-full bg-brand-950 dark:bg-white/5 lg:grid lg:w-1/2">
                <div class="flex items-center justify-center z-1">
                    ...
                    <div class="flex flex-col items-center max-w-xs">
                        <a href="{{ route('beranda') }}" class="block mb-4">
                            <img src="{{ asset('images/logo-full.png') }}" alt="GudangJateng" class="h-12 w-auto">
                        </a>
                        <p class="text-center text-gray-400 dark:text-white/60">Sistem Manajemen Stok Gudang Jateng</p>
                    </div>
                </div>
            </div>
        </div>
