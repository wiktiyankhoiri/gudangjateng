...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] max-w-2xl">
    <form method="post" action="{{ route('pengaturan.user.store') }}">
        @csrf
        <div class="p-5">
            @if ($errors->any())
