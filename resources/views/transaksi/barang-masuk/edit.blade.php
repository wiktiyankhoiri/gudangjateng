    ...
    <table class="table-sticky min-w-full text-sm">
        ...
        <tbody id="daftarBarang" class="divide-y divide-gray-100 dark:divide-gray-800">
            ...
            <tr class="row-barang">
                ...
                <td class="px-1 py-3">
                    <input type="number" name="qty_baik[]" value="{{ $d->qty_baik }}" min="0"
                ...
                <td class="px-1 py-3">
                    <input type="number" name="qty_rusak[]" value="{{ $d->qty_rusak }}" min="0"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Init TomSelect untuk existing pabrik/toko fields
