...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function toggleHeader() {
        ...
        document.querySelectorAll('.qty-rusak-input').forEach(function(input) {
            input.disabled = (tipe === 'pabrik');
            if (tipe === 'pabrik') {
                input.value = 0;
    ...
    document.getElementById('btnTambah').addEventListener('click', function() {
        ...
        <div class="flex flex-col sm:flex-row gap-2 items-start p-3 border border-gray-200 rounded-lg dark:border-gray-800 row-barang">
            ...
            <div class="w-full sm:w-24 qty-rusak-field">
                ...
                <input type="number" name="qty_rusak[]" class="qty-rusak-input dark:bg-dark-900 shadow-theme-xs h-11 w-full rounded-lg border border-gray-300 bg-transparent px-3 py-2 text-sm text-gray-800 focus:border-brand-300 focus:ring-3 focus:ring-brand-500/10 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90" min="0" value="0" disabled>
            </div>
        ...
        var tipe = document.getElementById('tipe').value;
        var newRow = document.getElementById('bodyBarang').lastElementChild;
        var newQtyRusak = newRow.querySelector('.qty-rusak-input');
        if (newQtyRusak) {
            if (tipe === 'pabrik') {
                newQtyRusak.disabled = true;
                newQtyRusak.value = 0;
                newQtyRusak.classList.add('opacity-50', 'cursor-not-allowed');
            } else {
                newQtyRusak.disabled = false;
                newQtyRusak.classList.remove('opacity-50', 'cursor-not-allowed');
            }
        }
