...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    ...
    <form data-protect-submit="true" data-confirm-message="Pastikan data sudah sesuai dengan nota fisik. Lanjutkan simpan?" data-confirm-ok="Ya, Simpan" method="post"
        ...
        <div class="p-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-3 mt-4">
                ...
                <div>
                    ...
                    <select name="sumber" id="sumberStok" class="h-11 w-full rounded-lg border dark:bg-dark-900 border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:focus:border-brand-800" required>
                        <option value="gudang" {{ old('sumber') === 'sales' ? '' : 'selected' }}>Gudang</option>
                        <option value="sales" {{ old('sumber') === 'sales' ? 'selected' : '' }}>Sales (Kanvas)</option>
                    </select>
                </div>
                <div>
            ...
            <div class="flex flex-col sm:flex-row gap-2 items-end mb-6">
                ...
                <div class="w-full sm:w-20">
                    <label class="block text-xs font-medium text-gray-500 dark:text-gray-400 mb-1 text-center">Jumlah</label>
        ...
        <div class="flex items-center justify-between px-5 py-4 border-t border-gray-200 dark:border-gray-800">
            ...
            <button type="submit" class="inline-flex items-center gap-2 rounded-lg bg-brand-500 px-4 py-3 text-sm font-medium text-white shadow-theme-xs transition hover:bg-brand-600" data-loading-text="Menyimpan...">
