...
<!-- ====== ROW 4: Stok Opname + Penyesuaian Stok ====== -->
<div class="mt-6 md:mt-8 grid grid-cols-12 gap-4 md:gap-6">
    <div class="col-span-12 lg:col-span-6">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
            ...
            <div class="mt-3 flex">
                ...
                <div class="flex-1 text-center border-r border-gray-200 dark:border-gray-700 last:border-r-0">
                    ...
                    <p class="mt-1 text-sm font-semibold text-brand-600 dark:text-brand-400">{{ number_format($mutasiHariIni) }}</p>
                </div>
                <div class="flex-1 text-center border-r-0">
                    <p class="text-xs text-gray-500 dark:text-gray-400">Selisih Item</p>
                    <p class="mt-1 text-sm font-semibold {{ $totalSelisihItem >= 0 ? 'text-success-600 dark:text-success-500' : 'text-error-600 dark:text-error-500' }}">{{ ($totalSelisihItem >= 0 ? '+' : '') . number_format($totalSelisihItem) }}</p>
                </div>
            </div>
        </div>
    </div>
