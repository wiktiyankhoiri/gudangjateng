...
<div class="mt-6 md:mt-8 grid grid-cols-12 gap-4 md:gap-6">
    ...
    <div class="col-span-12 lg:col-span-6">
        <div class="rounded-2xl border border-gray-200 bg-white p-4 dark:border-gray-800 dark:bg-white/[0.03]">
            <h3 class="text-lg text-gray-500 dark:text-gray-400">Ringkasan Sistem</h3>
            <div class="mt-3 grid grid-cols-4">
                <div class="text-center border-r border-gray-200 dark:border-gray-700 last:border-r-0">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ number_format($totalBarang) }}</p>
                </div>
                <div class="text-center border-r border-gray-200 dark:border-gray-700 last:border-r-0">
                    <p class="text-xs text-gray-500 dark:text-gray-400">Total Pengguna</p>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ number_format($userAktif) }}</p>
                </div>
                <div class="text-center border-r border-gray-200 dark:border-gray-700 last:border-r-0">
                    <p class="text-xs text-gray-500 dark:text-gray-400">Log Audit</p>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ number_format($totalAuditLog) }}</p>
                </div>
                <div class="text-center border-r-0">
                    <p class="text-xs text-gray-500 dark:text-gray-400">Cadangan</p>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">{{ number_format($totalBackup) }}</p>
                </div>
            </div>
        </div>
    </div>
