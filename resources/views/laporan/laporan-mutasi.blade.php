...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
        ...
        <div class="flex flex-col gap-4 sm:flex-row">
            <div class="filter-item" style="flex:1 1 200px; min-width:140px;">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="keyword" value="{{ $keyword ?? '' }}" class="dark:bg-dark-900 shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:focus:border-brand-800 h-11 w-full rounded-lg border border-gray-300 bg-transparent bg-none px-4 py-2.5 pl-[62px] text-sm text-gray-800 placeholder:text-gray-400 focus:ring-3 focus:outline-hidden dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30" placeholder="Cari...">
                </div>
            </div>
            ...
            <div class="filter-btn-wrap" style="flex-shrink:0; padding-top:28px;">
                <div class="flex gap-2">
                    ...
                    <a href="{{ route('laporan.mutasi.index') }}" class="inline-flex items-center justify-center gap-2 rounded-lg bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-theme-xs ring-1 ring-inset ring-gray-300 transition hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-400 dark:ring-gray-700 dark:hover:bg-white/[0.03]">
                ...
                @if(!empty($data))
                    ...
                    <tr>
                        ...
                        <td class="px-5 py-4 text-center">
                            <a href="{{ route('transaksi.mutasi.detail', $d->id) }}" class="text-sm font-semibold text-brand-500 hover:text-brand-600 dark:text-brand-400">{{ $d->no_mutasi ?? '-' }}</a>
                        </td>
    ...
    <div class="px-5 py-4 border-t border-gray-200 dark:border-gray-800">
        {{ $data->appends(request()->only(['keyword', 'tanggal_awal', 'tanggal_akhir']))->links('vendor.pagination.tailadmin') }}
    </div>
    @endif
</div>
