...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    <form method="post" action="{{ route('masterdata.pabrik.store') }}" autocomplete="off">
        @csrf
        <div class="p-5">
            @if ($errors->any())
            ...
            <div class="flex flex-col gap-6 pt-3 pb-3">
                <div class="flex flex-col gap-6 md:flex-row">
                    <div class="md:w-1/3">
                        ...
                        <input type="text" name="kode_pabrik" value="{{ old("kode_pabrik") }}" placeholder="Masukkan kode pabrik" required
                    ...
                    <div class="md:flex-1">
                        ...
                        <input type="text" name="nama_pabrik" value="{{ old("nama_pabrik") }}" placeholder="Masukkan nama pabrik" required
                            class="h-11 w-full rounded-lg border dark:bg-dark-900 border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800 uppercase"
                            oninput="const s=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(s,s)">
                ...
                <div>
                    ...
                    <textarea name="alamat" rows="3" placeholder="Masukkan alamat pabrik secara lengkap" required
                        ...
                        oninput="const s=this.selectionStart;this.value=this.value.toUpperCase();this.setSelectionRange(s,s)">{{ old("alamat") }}</textarea>
