        ...
        <div class="p-5">
            ...
            <div class="flex flex-col gap-6 md:flex-row">
                <div class="md:w-1/3">
                    ...
                    <input type="number" name="harga_gold" value="{{ old('harga_gold', $barang->harga_gold !== null ? (int) $barang->harga_gold : '') }}" placeholder="0" min="0" step="1"
                ...
                <div class="md:w-1/3">
                    ...
                    <input type="number" name="harga_grosir" value="{{ old('harga_grosir', $barang->harga_grosir !== null ? (int) $barang->harga_grosir : '') }}" placeholder="0" min="0" step="1"
                        class="h-11 w-full rounded-lg border dark:bg-dark-900 border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
                ...
                <div class="md:w-1/3">
                    ...
                    <input type="number" name="harga_khusus" value="{{ old('harga_khusus', $barang->harga_khusus !== null ? (int) $barang->harga_khusus : '') }}" placeholder="0" min="0" step="1"
                        class="h-11 w-full rounded-lg border dark:bg-dark-900 border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-theme-xs placeholder:text-gray-400 focus:border-brand-300 focus:outline-hidden focus:ring-3 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-brand-800">
