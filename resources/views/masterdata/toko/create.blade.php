...
<div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
    <form method="POST" action="{{ route('masterdata.toko.store') }}" autocomplete="off">
        @csrf
        <div class="p-5">
            @if ($errors->any())
            ...
            <div class="flex flex-col gap-6 pt-3 pb-3">
                <div class="flex flex-col gap-6 md:flex-row">
                    <div class="md:w-1/3">
                        ...
                        <input type="text" name="kode_toko" value="{{ old("kode_toko") }}" placeholder="Masukkan kode toko" required
